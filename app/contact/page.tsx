    ...
    <div className="relative min-h-screen bg-background font-sans text-foreground selection:bg-primary/30">
      ...
      <div className="relative z-10 mx-auto max-w-350 px-6 pt-6 pb-8">
        ...
        >
          ...
          <motion.div
            variants={itemVariants}
            className="group relative overflow-hidden rounded-[2rem] border border-black/8 bg-black/2 p-8 shadow-lg backdrop-blur-[48px] sm:p-12 md:col-span-7 dark:border-white/6 dark:bg-[#111111]/25"
          >
            <div
              className="pointer-events-none absolute inset-0 opacity-[0.05] mix-blend-overlay dark:opacity-[0.12]"
              style={{ backgroundImage: noiseSvg }}
            ...
            >
              ...
              <button
                ...
                className="group/btn relative mt-2 flex h-14 w-full items-center justify-center gap-2 rounded-2xl bg-foreground font-bold text-background transition-all hover:bg-foreground/90 disabled:opacity-70"
              >
                {isSubmitting ? (
