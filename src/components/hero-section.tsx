...
const roles = ["building interfaces", "crafting React apps", "exploring Firebase", "learning DevOps", "creating solutions"]
        ...
        <div className="grid gap-12 lg:grid-cols-2 lg:gap-20 lg:items-center lg:min-h-[70vh]">
          ...
          <div className="space-y-8 sm:space-y-10">
            ...
            >
              ...
              Passionate about building responsive apps and exploring areas like AI, DevOps, and automation. 
              Based in <span className="text-foreground font-medium">Bhavnagar, India</span>.
            </p>
